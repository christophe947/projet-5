...
use KnpU\OAuth2ClientBundle\Client\ClientRegistry; // \Oauth2ClientBundle\src\Client\ClientRegistry;
//use KnpU\OAuth2ClientBundle\src\Client\ClientRegistry;
...
public function registerAction(Request $request, ClientRegistry $clientRegistry)
{
    ...
    $this->addFlash('info', "mdp send in your mail");
//Redirect to google

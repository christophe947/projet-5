 ...
 */
final class Version20231007131410 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D6492E805CC6 FOREIGN KEY (picture_profil_id) REFERENCES picture (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
